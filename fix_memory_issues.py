#!/usr/bin/env python3
"""
메모리 문제 해결을 위한 train_experiments.py 수정
- GPU 메모리 누적 방지
- 명시적 메모리 정리
- 더 작은 배치 크기
"""
...
'''
    ...
    with open("train_experiments_fixed.py", 'w', encoding='utf-8') as f:
        f.write(fixed_code)
    
    print("Created memory-efficient train_experiments_fixed.py")
